...
WITH area_lookup(
    ...
    reporting_lon,
    reporting_area_kind,
    reporting_area_macro
) AS (
    -- Approximate point coordinates for source regions plus an oblast-level reporting region.
    VALUES
        ('Odesa oblast', 'Odesa oblast', 46.48, 30.72, 'oblast', 46.48, 30.72, 'oblast', 'south'),
        ('Mykolaiv oblast', 'Mykolaiv oblast', 46.97, 31.99, 'oblast', 46.97, 31.99, 'oblast', 'south'),
        ('Kyiv oblast', 'Kyiv oblast', 50.45, 30.52, 'oblast', 50.45, 30.52, 'oblast', 'north'),
        ('Lviv oblast', 'Lviv oblast', 49.84, 24.03, 'oblast', 49.84, 24.03, 'oblast', 'west'),
        ('Rivne oblast', 'Rivne oblast', 50.62, 26.25, 'oblast', 50.62, 26.25, 'oblast', 'west'),
        ('Volyn oblast', 'Volyn oblast', 50.75, 25.33, 'oblast', 50.75, 25.33, 'oblast', 'west'),
        ('Kherson oblast', 'Kherson oblast', 46.64, 32.62, 'oblast', 46.64, 32.62, 'oblast', 'south'),
        ('Khmelnytskyi oblast', 'Khmelnytskyi oblast', 49.42, 26.99, 'oblast', 49.42, 26.99, 'oblast', 'center-west'),
        ('Poltava oblast', 'Poltava oblast', 49.59, 34.55, 'oblast', 49.59, 34.55, 'oblast', 'center-east'),
        ('Kharkiv oblast', 'Kharkiv oblast', 49.99, 36.23, 'oblast', 49.99, 36.23, 'oblast', 'east'),
        ('Sumy oblast', 'Sumy oblast', 50.91, 34.80, 'oblast', 50.91, 34.80, 'oblast', 'north-east'),
        ('Chernihiv oblast', 'Chernihiv oblast', 51.50, 31.29, 'oblast', 51.50, 31.29, 'oblast', 'north'),
        ('Zaporizhzhia oblast', 'Zaporizhzhia oblast', 47.84, 35.14, 'oblast', 47.84, 35.14, 'oblast', 'south-east'),
        ('Dnipropetrovsk oblast', 'Dnipropetrovsk oblast', 48.47, 35.04, 'oblast', 48.47, 35.04, 'oblast', 'center-east'),
        ('Donetsk oblast', 'Donetsk oblast', 48.72, 37.55, 'oblast', 48.72, 37.55, 'oblast', 'east'),
        ('Kirovohrad oblast', 'Kirovohrad oblast', 48.51, 32.26, 'oblast', 48.51, 32.26, 'oblast', 'center'),
        ('Vinnytsia oblast', 'Vinnytsia oblast', 49.23, 28.48, 'oblast', 49.23, 28.48, 'oblast', 'center-west'),
        ('Cherkasy oblast', 'Cherkasy oblast', 49.44, 32.06, 'oblast', 49.44, 32.06, 'oblast', 'center'),
        ('Ivano-Frankivsk oblast', 'Ivano-Frankivsk oblast', 48.92, 24.71, 'oblast', 48.92, 24.71, 'oblast', 'west'),
        ('Kursk oblast', 'Kursk oblast', 51.73, 36.19, 'foreign_oblast', 51.73, 36.19, 'foreign_oblast', 'international'),
        ('Kyiv', 'Kyiv oblast', 50.45, 30.52, 'city', 50.45, 30.52, 'oblast', 'north'),
        ('Odesa', 'Odesa oblast', 46.48, 30.72, 'city', 46.48, 30.72, 'oblast', 'south'),
        ('Kharkiv', 'Kharkiv oblast', 49.99, 36.23, 'city', 49.99, 36.23, 'oblast', 'east'),
        ('Kherson', 'Kherson oblast', 46.64, 32.62, 'city', 46.64, 32.62, 'oblast', 'south'),
        ('Dnipro', 'Dnipropetrovsk oblast', 48.47, 35.04, 'city', 48.47, 35.04, 'oblast', 'center-east'),
        ('Zaporizhzhia', 'Zaporizhzhia oblast', 47.84, 35.14, 'city', 47.84, 35.14, 'oblast', 'south-east'),
        ('Sumy', 'Sumy oblast', 50.91, 34.80, 'city', 50.91, 34.80, 'oblast', 'north-east'),
        ('Kramatorsk', 'Donetsk oblast', 48.72, 37.55, 'city', 48.72, 37.55, 'oblast', 'east'),
        ('Kryvyi Rih', 'Dnipropetrovsk oblast', 47.91, 33.39, 'city', 48.47, 35.04, 'oblast', 'center-east'),
        ('Starokostiantyniv', 'Khmelnytskyi oblast', 49.76, 27.22, 'city', 49.42, 26.99, 'oblast', 'center-west'),
        ('Kolomyia', 'Ivano-Frankivsk oblast', 48.53, 25.04, 'city', 48.92, 24.71, 'oblast', 'west'),
        ('Ochakiv', 'Mykolaiv oblast', 46.61, 31.54, 'city', 46.97, 31.99, 'oblast', 'south'),
        ('Snake Island', 'Odesa oblast', 45.26, 30.20, 'special', 46.48, 30.72, 'oblast', 'south')
),
mapped AS (
    ...
    SELECT
        ...
        COALESCE(area_lookup.reporting_area_macro, 'unknown') AS area_macro,
...
summary AS (
    SELECT
        reporting_region,
        CASE
            WHEN COUNT(DISTINCT area_macro) = 1 THEN MIN(area_macro)
            ELSE 'Mixed'
        END AS area_macro,
